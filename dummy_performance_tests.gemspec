Gem::Specification.new do |gem|
  ...
  gem.description       = "Generates dummy performance tests for Rails 3 applications by using the data generated by dummy_data and dummy_urls"
  gem.rubyforge_project = gem.name

  gem.required_rubygems_version = ">= 1.3.7"
  
  gem.add_dependency "dummy_data", ">= 0.9"
  gem.add_dependency "dummy_urls", ">= 0.9"
